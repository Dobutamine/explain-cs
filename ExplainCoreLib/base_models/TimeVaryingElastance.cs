...
{
	public class TimeVaryingElastance : BaseModel
	{
        ...
        public double el_min_factor = 1.0;
        public double el_max_factor = 1.0;
        public double el_k_factor = 1.0;
        public double act_factor = 1.0;

        public double vol = 1.0;
        public double pres = 0.0;
        public double pres_ed = 0.0;
        public double pres_ms = 0.0;
